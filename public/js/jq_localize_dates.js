...
$(document).ready(function() {
  ...
  if (!document.createElementNS) {
    ...
    for (var i=nodes.length; i-->0; ) {
      ...
      try {
        if (nodes[i].parentNode.nodeName == 'article') {
          div.style.styleFloat = 'right';
        } else if (nodes[i].parentNode.nodeName == 'footer') {
        ...
        div.appendChild(document.createTextNode(err.toString()));
      }
...
/*
  document.write('<script src="/js/svgweb/svg.js" data-path="/js/svgweb"><' +
    '/script>');
*/
}
